...
Older versions: Version 4 (September 2025), Version 3 (July 2025), Version 2 (March 2025), Version 1 (December 2024)
## Data Dictionary
...
* draft: symbol of the draft resolution (435,975 empty rows).
* committee_report: symbol of the report of the main General Assembly Committee, transmitting texts of draft resolutions (189,798 empty rows).
...
* subjects: concept or combination of concepts describing the subject of the resolution (234,818 empty rows).
* vote_note: additional voting information (947,075 empty rows).
