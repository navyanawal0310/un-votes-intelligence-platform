...
United Nations Security Council Voting Data: resolution 1 (24 January 1946) to resolution 2815 (30 January 2026)
...
This dataset is a compilation of the voting data of the Security Council until 30 January 2026. It is derived from the UN Digital Library voting records and provides information on Member States' votes related to adopted resolutions up to resolution 2815 (2026) adopted on 30 January 2026. Votes on paragraphs of draft resolutions or drafts that failed to be adopted are not included. The dataset comprises 41,349 entries, representing the vote of one Member State for a particular draft resolution. This dataset is updated several times a year.
Copyright, United Nations; non-commercial use with attribution.

## Citation

United Nations Dag Hammarskjöld Library, Security Council Voting Data, United Nations, 2026, Version 6 (February 2026), downloaded from https://digitallibrary.un.org/record/4055387, [download date]

## Version

Version 6 (February 2026)
Older versions: Version 5 (9 Dec. 2025), Version 4 (25 Nov. 2025), Version 3 (21 July 2025), Version 2 (31 March 2025), Version 1 (30 June 2024)
...
* draft: Symbol of the draft resolution; 13,440 rows without values; this data point is completed from 1998 onwards.
...
* agenda: Agenda item of the Security Council; 3,210 rows without values.
* subjects: Concepts that describe the subject of the adopted resolution and/or draft; 7,509 rows without values; this data point is complete for votes dated 1985 onwards.
* vote_note: A note is only added to indicate peculiarities: a Member State that was not present and/or did not participate in the vote, adoption of the resolution without a vote or by acclamation, etc; 38,809 rows without values.
